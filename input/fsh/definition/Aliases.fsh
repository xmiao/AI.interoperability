...
Alias: $loinc = http://loinc.org
Alias: $sct = http://snomed.info/sct
Alias: $apgarcolor = http://acme.ped/apgarcolor
Alias: $apgarheartrate = http://acme.ped/apgarheartrate
Alias: $apgarreflexirritability = http://acme.ped/apgarreflexirritability
Alias: $apgarmuscletone = http://acme.ped/apgarmuscletone
